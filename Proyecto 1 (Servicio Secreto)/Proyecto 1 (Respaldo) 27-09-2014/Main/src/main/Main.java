...

{
    ...
    
    {
        ...
        sucre.remover(sucre);
        sucre.remover(goncalves);
        lopez.remover(sucre);
        lopez.remover(lopez);
        lopez.agregarAdyacente(goncalves);
        System.out.println();        
        System.out.println("Imprimiendo casos de prueba");
        System.out.println();        
        lopez.imprimir();
        sucre.imprimir();
        goncalves.imprimir();
        System.out.println();
        System.out.println("Probando obtenerAlcanzable");
        System.out.println();
        lopez.obtenerAlcanzables();
        sucre.obtenerAlcanzables();
        goncalves.obtenerAlcanzables();
       
        System.out.println("Probando Red Aplanada");
        agentesUSB.aplanarRed();
        
        goncalves.imprimir();
        lopez.imprimir();
        sucre.imprimir();
        agentesUSB.cobertores();
    }
