...
/*
   Implementación de la clase Nodo, el nodo es la unida básica del grafo y en 
   esta implementación consta de un String como nombre y de un HashSet que 
   representa el conjunto de adyacencia del nodo
 */
...

{
	...
	private final String nombre_; // Nombre con el cual se identifica al nodo
	...
	public Nodo(String nombre,HashSet<Nodo> adyacentes)
        ...
        {	
            ...
            adyacentes_ = new HashSet(); // Inicializamos su conjunto de 
                                         // adyaencia
            adyacentes_ = adyacentes;    // Agregamos los nodos
        }
	...
	public String obtenerNombre()
        ...
        // Metodo para obtener el estado de visita del nodo
