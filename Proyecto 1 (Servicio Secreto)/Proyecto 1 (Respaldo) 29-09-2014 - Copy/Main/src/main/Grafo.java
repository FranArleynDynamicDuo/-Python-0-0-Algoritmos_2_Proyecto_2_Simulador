	...
	private HashSet <Nodo> hojas_;
                ...
                
        {
            ...
            //int i = 0; // Inicio el contador para saber cuando estoy en el
                       // ultimo nodo para enmarcar la 
            
            Grafo grafoAplanado = new Grafo();
            
            for (Nodo hoja : hojas_) // Recorro todos los nodos del conjunto 
                                     // e imprimimos sus alcanzables 1 a 1
            {
                HashSet alcanzable = hoja.obtenerAlcanzables();
                
                for (Nodo nodo : hoja.obtenerAlcanzables())
                    
                {
                    hoja.agregarAdyacente(nodo);
                }
                
                
                grafoAplanado.agregarNodo(hoja); // Obtengo los nodos alcanzables por
                                           // cada nodo  
            }
            

            return grafoAplanado;
        }
                ...
                
        {
            ...
            if (mensajes == 1) // Repuesta en caso de que solo sea 1 mensaje
                
            {
                System.out.println();
                System.out.println("Se necesita " + mensajes + " mensaje");
                System.out.println();
            
            }
            
            if (mensajes > 1) // Respuest en caso de multiples mensajes
                
            {    
                
                System.out.println();
                System.out.println("Se necesitan " + mensajes + " mensajes");
                System.out.println();
